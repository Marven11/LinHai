...
class TestCreateAgent(unittest.TestCase):
    ...
    def test_create_agent_basic_functionality(self):
        ...
        result = create_agent(group_chat, config_path)
    ...
    def test_create_agent_with_llm_name(self):
        ...
        # 使用llm_name参数
        result = create_agent(group_chat, config_path, llm_name="deepseek")
        self.assertIsInstance(result, GroupChat)
    ...
    def test_create_agent_with_invalid_llm_name(self):
        ...
        with self.assertRaises(ValueError) as context:
            create_agent(group_chat, config_path, llm_name="invalid_llm")
