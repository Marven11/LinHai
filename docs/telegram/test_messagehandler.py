...
class TestMessageHandler(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.false_updates = [
            Update(1, callback_query=CallbackQuery(1, User(1, "", False), "chat", message=self.message)),
            Update(1, inline_query=InlineQuery(1, User(1, "", False), "", "")),
            Update(1, chosen_inline_result=ChosenInlineResult("id", User(1, "", False), "")),
            Update(1, shipping_query=ShippingQuery("id", User(1, "", False), "", None)),
            Update(1, pre_checkout_query=PreCheckoutQuery("id", User(1, "", False), "", 0, "")),
    ...
    def test_callback_query_with_filter(self):
        ...
        update = Update(1, callback_query=CallbackQuery(1, None, None, message=self.message))
    ...
    def test_specific_filters(self):
        ...
        self.assertTrue(handler.check_update(Update(0, edited_channel_post=self.message)))
