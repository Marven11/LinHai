...
class TestLlmManager(unittest.IsolatedAsyncioTestCase):
    ...
    def test_initialization(self):
        self.assertEqual(self.llm_manager.llm_names[self.llm_manager.current_llm_index], "llm1")
    ...
    async def test_switch_to_llm(self):
        ...
        self.assertEqual(self.llm_manager.llm_names[self.llm_manager.current_llm_index], "llm2")
