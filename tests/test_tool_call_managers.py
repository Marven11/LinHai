...
class TestLoadImageUrlWarningPlugin(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_warning_for_http_url(self):
        ...
        tool_calls = [
            {
                "name": "load_image",
                "arguments": {
                    "image_filepath": "http://example.com/image.jpg"
                }
            }
        ]
        ...
        self.assertIn("警告：load_image工具的参数image_filepath看起来是一个URL", call_args.message)
        self.assertIn("请使用fetch_article等工具先下载图片到本地", call_args.message)
        ...
        tool_calls = [
            {
                "name": "load_image",
                "arguments": {
                    "image_filepath": "https://example.com/image.png"
                }
            }
        ]
        ...
        tool_calls = [
            {
                "name": "load_image",
                "arguments": {
                    "image_filepath": "ftp://example.com/image.gif"
                }
            }
        ]
        ...
        tool_calls = [
            {
                "name": "load_image",
                "arguments": {
                    "image_filepath": "/home/user/image.jpg"
                }
            }
        ]
        ...
        tool_calls = [
            {
                "name": "load_image",
                "arguments": {
                    "image_filepath": "./images/photo.png"
                }
            }
        ]
    ...
    def test_register(self):
        ...
        self.mock_lifecycle.register_after_message_generation.assert_called_once_with(self.plugin.after_message_generation)
